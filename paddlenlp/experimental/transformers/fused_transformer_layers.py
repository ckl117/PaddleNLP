...
__all__ = [
    ...
    "FusedBlockMultiTransformerFP8ScaleTensor",
]
...
class MLAConfig:
    ...
    prefill_cache_k_buffer: paddle.Tensor = None
    prefill_cache_v_buffer: paddle.Tensor = None
...
class FusedBlockMultiTransformer(FusedMultiTransformerBase):
    ...
    def compute_attn(
        ...
        **kwargs,
        ...
        if self.config.mla_config.use_mla() and self.config.mla_config.use_matrix_absorption:
            return self.compute_mla(qkv_out, caches, i, **kwargs)
...
class FusedBlockMultiTransformerFP8ScaleTensor(FusedBlockMultiTransformer):
    def __init__(self, config: FusedMultiTransformerConfig):
        super().__init__(config)
        self.quant_type = config.quant_type
