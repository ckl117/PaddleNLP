...
def infererence_model_from_pretrained(cls, pretrained_model_name_or_path, args, kwargs, return_numpy=True):
    ...
    if True:
        ...
        # file_name = f"/root/paddlejob/workspace/env_run/output/model/split/r1_batch_gemm_fp8/{rank}.pdparams"
        ...
        paddle.distributed.barrier()
        rank = paddle.distributed.get_rank()
        file_name = f"/root/paddlejob/workspace/env_run/output/model/split/r1_batch_gemm/{rank}.pdparams"
